...
/**
 * This class defines the structure of the 'raw_dm' table.
 *
 *
 ...
 */
class RawDmTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.RawDmTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('raw_dm');
		$this->setPhpName('RawDm');
		$this->setClassname('RawDm');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addColumn('DM_ID', 'DmId', 'BIGINT', true, null, null);
