...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Users/pascaldevink/Development/Projects/twneed/src/log/frontend_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Users/pascaldevink/Development/Projects/twneed/src/cache/frontend/test/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Users/pascaldevink/Development/Projects/twneed/src/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'session_path' => '/Users/pascaldevink/Development/Projects/twneed/src/cache/frontend/test/test/sessions',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Users/pascaldevink/Development/Projects/twneed/src/cache/frontend/test/template',
  'lifetime' => 86400,
  'prefix' => '/Users/pascaldevink/Development/Projects/twneed/src/apps/frontend/template',
)));
